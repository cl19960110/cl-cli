...
const createCommands = ()=> {
  ...
  program
    ...
    .description('add vue组件,例如：why addvuecomp helloWorld ')
    .action((name) => {
  ...
  program
    ...
    .description('add vue page,例如：why addvuepage Home [-d src/pages]')
    .action((pageName) => {
  ...
  program
    ...
    .description('add vue store,例如：why addVueStore home [-d src/store]')
    .action((pageName) => {
